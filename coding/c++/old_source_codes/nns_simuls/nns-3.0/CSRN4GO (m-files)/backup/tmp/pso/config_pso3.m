function pso=config_pso3(board,nns,iter_max,nnc_type),
...
for N_n=2:nns.cell.N_n_max,
    ...
    elseif ( nnc_type=='snr' ),
        ...
        pso.cfg.a.id(N_n-1).d=row_W_h.*clmn_W_h;      % dimension
        pso.cfg.p.id(N_n-1).d=row_W_u.*clmn_W_u+row_W_v.*clmn_W_v +pso.cfg.a.d;   % dimension
    else,
