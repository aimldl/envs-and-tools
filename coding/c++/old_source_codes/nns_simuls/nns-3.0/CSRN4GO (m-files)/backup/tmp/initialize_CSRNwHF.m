...
% CSRNwHF.cfg.struct=[board.max_board, board.max_board];    % row-by-column structure
% 
...
for x=1:board.max_board,
    for y=1:board.max_board,
        ...
        %
        % CSRNwHF.cfg.No_neurons(1): Number of neurons at layer 1
        % CSRNwHF.cfg.No_neurons(2): Number of neurons at layer 2
        %
        ...
        N_v=1;
%        CSRNwHF.cfg.No_neurons=[2.*board.string_size_max,1];        
        CSRNwHF.cfg.No_neurons=[ N_u, N_h, N_v ];
...
%        CSRNwHF.srn(x,y).W=zeros( CSRNwHF.cfg.No_neurons(1),CSRNwHF.srn(x,y).input_lengh );
%        CSRNwHF.srn(x,y).V=zeros( CSRNwHF.cfg.No_neurons(2),CSRNwHF.cfg.No_neurons(1) );
