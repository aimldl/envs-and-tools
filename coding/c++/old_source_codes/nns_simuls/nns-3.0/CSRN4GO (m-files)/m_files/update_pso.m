function [data,nns,pso] = update_pso(board,nns,data,pso,nn,nnc_type)
...
if ( nnc_type=='mlp' ),
     for pp=1:size_p,
        ...
        for bb=1:bb_max,
            ...
            [nns,data,e_t] = calculate_cmlp_output(nns,data,e_t,bb,board_max);
        end;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        pso = update_pso_local_best(pso,e_t,nn,N_n_max,pp);
     end;
     pso = update_pso_global_best(pso,N_n_max);
     pso = add_fitness_g(pso,N_n_max);             % Merge the total error
     pso=update_pso_particle_locations(pso,N_n_max);
elseif( nnc_type=='srn' ),
     ...
     for pp=1:size_p,
        ...
        for bb=1:bb_max,
            nns = interface_data2cnns(nns,data,bb,board_max);
            [nns,data,e_t] = calculate_csrn_output(nns,data,e_t,bb,board_max,oo_max);
        end;
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        pso = update_pso_local_best(pso,e_t,nn,N_n_max,pp);
     end;
