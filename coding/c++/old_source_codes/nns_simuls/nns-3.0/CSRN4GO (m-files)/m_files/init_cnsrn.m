function nns=init_cnsrn(board,oo_max,ii_max);

% init_cnsrn         initialize a structure cnsrn 
%                    CNSRN (Cellular Nested Simultaneous Recurrent Networks)
%
%
...
nns.cfg.iter_max     = oo_max;                          % Iteration within SRN
...
for N_n=2:nns.cell.N_n_max,
    ...
    nns.cell.id(N_n-1).N_e  = N_e;                          % Number of neurons in output layer
    ...
    nns.cell.id(N_n-1).W_h  = zeros( N_h,N_e );
...
% This is a quick fix for an error for NSR, revisit this. Jul. 22, 2008
nns.cfg.N_h=N_h;
