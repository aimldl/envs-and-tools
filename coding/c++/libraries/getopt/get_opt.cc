...
// Change SDL Checks to No to use getenv or
// #define _CRT_SECURE_NO_WARNINGS
...
// TODO: Modify the operator so that "const argv" can be used.
...
int GetOpt::operator () (void) {
  ...
  // Look at and handle the next option-character.
  {
    ...
    // Increment `optind' when we start to parse its last character.
    if (*nextchar == 0)
      optind++;
...
// Error: 'getenv': This function or variable may be unsafe. Consider using _dupenv_s instead.
//                  To disable deprecation, use _CRT_SECURE_NO_WARNINGS.
//                  See online help for details.
// TKIM
// Problem
//  else if (getenv("_POSIX_OPTION_ORDER") != 0)
// Hint https://docs.microsoft.com/en-us/cpp/c-runtime-library/reference/dupenv-s-wdupenv-s?view=vs-2017
// Solution
//  char   *pValue;
//  size_t len;
//  errno_t err = _dupenv_s(&pValue, &len, "_POSIX_OPTION_ORDER");
//     (...)
//  else if ( strcmp(pValue, "(null)") != 0 )
// TKIM

// TKIM
//char   *pValue;
//char   str2cmp[] = "(null)";
//strcpy_s(str2cmp, sizeof( str2cmp ), );
