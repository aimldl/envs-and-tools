...
# -*- coding: utf-8 -*-
"""
exploratory_data_analysis-imdb_movie_review_dataset.py
...
'''
TODO:
1. emoticons, hashtag, etc.
2. Plots don't show the GUI window for hist, boxplot, and so on.
...
def print_stats( data, name ):
    ...
    """
    assert isinstance( name, str ), '%s must be a string' % name
