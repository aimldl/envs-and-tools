...
The rest of them remains identical.
├── accessKeys-Administrator.csv
├── remotemachine-aws_ec2_oregon.json
└── service-2.json

Another perspective to see the files is

For `aimldl-office-2021`

.pem
├── aimldl-office-2021.pem

.ppk
├── aimldl-office-2021.ppk
