...
The version number can be checked in the [download page](https://www.nvidia.com/download/index.aspx?lang=en-us). For details, refer to [Install NVIDIA Graphics Card Driver on Ubuntu Manually](install_nvidia_graphics_driver_manually.md). (2. Download the driver installation file)
