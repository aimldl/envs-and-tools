##### aimldl/computing_environments/anaconda/package_plan.md
* Draft: 2020-0316 (Mon)
# Package Plan
The following is the package plan for conda 4.8.2. which is the output during Anaconda installation. More specifically,
```bash
