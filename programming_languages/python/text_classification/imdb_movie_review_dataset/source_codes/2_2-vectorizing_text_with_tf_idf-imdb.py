# -*- coding: utf-8 -*-
"""
3_vectorizing_text_with_tf_idf-imdb_movie_review_dataset.py
...
# Saved to ../data/output/movie_review-tf_idf-logistic_regression-result.csv...

'''
TODO: Convert the output to a readable form.
From
  id       sentiment
  12311_10 1
  8348_2   0
...
to
  ...
  12311_10 1          Put the original sentence here.
  8348_2   0          So the result can be interpreted.
    ...
  11465_10 0          The text is required so I can judge which sentiment is correct.
'''